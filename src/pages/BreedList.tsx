...
const breeds = [{
  id: 'corgi',
  name: 'Corgi',
  description: 'Estão entre as 11 raças mais inteligentes segundo ranking da inteligência canina de Coren .',
  ...
  characteristics: ['Ativo e atlético', 'Ótimo com crianças', 'Necessita de exercícios regulares', 'Afetuoso e leal'],
  ...
  characteristics: ['Pelagem hipoalergênica', 'Ótimo para apartamentos', 'Temperamento doce e gentil', 'Baixa necessidade de exercícios'],
  size: 'Pequeno',
  weight: '5-10 kg',
  height: '20-30 cm',
  ...
  id: 'bichon-frise',
  name: 'Bichon Frisé',
  description: 'Reconhecido por sua pelagem branca em espiral e aparência de “puff”, além de ser um cão de performance em shows .',
  ...
  characteristics: ['Não solta pelo (hipoalergênico)', 'Excelente para apartamentos', 'Muito sociável e afetuoso', 'Brincalhão e inteligente'],
  size: 'Pequeno',
  weight: '3-5 kg',
  height: '23-30 cm',
  ...
  id: 'spitz-alemao',
  name: 'Spitz Alemão',
  description: 'Descendente de cães nórdicos e dos povos vikings, sua aparência lembra a de raposas e mantém seu instinto atento.',
  ...
  characteristics: ['Personalidade vivaz e alerta', 'Adaptável a diferentes ambientes', 'Afetuoso e enérgico', 'Ótimo cão de companhia'],
  size: 'Pequeno',
  weight: '1.5-4.5 kg',
  height: '18-22 cm',
  ...
  id: 'cavalier',
  name: 'Cavalier',
  description: 'Bom convívio com pessoas e pets. Descendente de cães de companhia reais, era usado para aquecer colo de nobres no século XVII.',
  ...
  characteristics: ['Excelente com crianças', 'Adaptável a qualquer ambiente', 'Necessita de companhia constante', 'Pelagem sedosa e fácil de cuidar'],
  size: 'Pequeno',
  weight: '5.5-8 kg',
  height: '30-33 cm',
  lifeExpectancy: '12-15 anos',
  ...
  return <div className="py-16 bg-amber-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {breeds.map(breed => <div key={breed.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <ul className="space-y-1">
                    {breed.characteristics.slice(0, 2).map((characteristic, index) => <li key={index} className="flex items-start text-gray-600">
                          <CheckIcon className="w-5 h-5 text-amber-600 mr-2 flex-shrink-0" />
                          <span>{characteristic}</span>
                        </li>)}
                  </ul>
                </div>
                <Link to={`/racas/${breed.id}`} className="inline-block bg-amber-600 hover:bg-amber-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
                  Saiba mais
                </Link>
              </div>
            </div>)}
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex items-start">
              <CheckIcon className="w-6 h-6 text-amber-600 mr-2 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-amber-800">Pedigree CBKC</h3>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Todos os filhotes são vacinados e vermifugados
                </p>
              </div>
            </div>
            <div className="flex items-start">
